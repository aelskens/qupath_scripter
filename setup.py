...
# Package meta-data.
NAME = "qupath_scripter"
DESCRIPTION = "ThThis project aims at facilitating the scripting with QuPath by setting a correct environment and supplying with various scripts and templates."
URL = "https://github.com/aelskens/qupath_scripter"
...
setup(
    ...
    classifiers=[
        ...
        "License :: OSI Approved :: CC0 v1.0 Universal",
